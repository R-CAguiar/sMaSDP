...
This compilation of codes details a gait event detection protocol, with a guide for the segmentation of EMG data, using a single IMU sensor. Please cite accordingly if any of these codes are used (details in CITATION.CFF). The dataset this protocol uses was made available by:
